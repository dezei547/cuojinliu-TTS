...
from utils.gpt.model_v2 import UnifiedVoice
from utils.utils.maskgct_utils import build_semantic_model, build_semantic_codec
from utils.utils.checkpoint import load_checkpoint
from utils.utils.front import TextNormalizer, TextTokenizer

from utils.s2mel.modules.commons import load_checkpoint2, MyModel
from utils.s2mel.modules.bigvgan import bigvgan
from utils.s2mel.modules.campplus.DTDNN import CAMPPlus
from utils.s2mel.modules.audio import mel_spectrogram
...
class IndexTTS2:
    def __init__(
        ...
        if self.use_cuda_kernel:
            ...
            try:
                from utils.s2mel.modules.bigvgan.alias_free_activation.cuda import activation1d
